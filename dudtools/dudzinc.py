#!/bin/env python
"""Generate potential decoy list by querying ZINC.

Michael Mysinger 200607 Created as dud.py 
Michael Mysinger 200608 Added fingerprint and tanimoto sections
Michael Mysinger 200609 Use threadpools
Michael Mysinger 200701 Get ligands from dud2_2006 release
Michael Mysinger 200703 Use dudtools
Michael Mysinger 200705 Move decoy cleaning after tanimoto filter 
Michael Mysinger 200804 Rewrite as dudzinc.py, what is needed for one 
                        set of ligands, Make code more reuseable.
Michael Mysinger 200908 Generate only free and purchasable decoys
Michael Mysinger 201108 Share command line code, add more options
Michael Mysinger 201109 Remove 75% of decoys by ECFP4 to drastically
                        reduce decoys that may be ligands
"""
...
try:
    ...
    print "Could not find needed tanimoto extension module!"
    print "You may need to install it using:"
    print "  python $dud/tanimoto/setup.py install"
    print "  Note: this requires appropriate permissions"
    sys.exit(3)

try:
    tanimoto.fractionfilterB
except AttributeError:
    print "The installed tanimoto extension module is an old version!"
    print "Please re-install it using:"
    print "  python $dud/tanimoto/setup.py install"
    print "  Note: this requires appropriate permissions"
    sys.exit(3)  
