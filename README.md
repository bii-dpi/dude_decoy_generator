...
5. `05_select_protonated.py`: generates SMILES corresponding to the selected protonated states of the supplied actives in pH 6-8. Decoys are found for both the original active and these forms before combination.
